...
output=/scratch/genevol/users/lucas/chr"$chr"_1.vcf.gz
output2=/scratch/genevol/users/lucas/chr"$chr"_2_1
samp=/raid/genevol/heritability/samples.txt
echo ${chr}
bcftools view --samples-file $samp -o $output $input
plink --vcf $output --hwe 0.0001 --geno 0 --indep 50 5 1.11 --maf 0.01 --vcf-half-call missing  --out $output2
